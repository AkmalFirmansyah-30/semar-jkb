...
<head>
    ...
    <style>
        ...
        .corner-blob {
            ...
            top: 0; 
            right: 0;
            width: 110px; /* Sesuaikan ukuran elemen1.png di sini */
            z-index: 1;
            pointer-events: none; /* Agar gambar tidak menghalangi klik jika beririsan */
        }
        ...
        <div class="col-lg-6 d-flex justify-content-center align-items-center bg-white p-4">
            <div class="login-card p-4 p-md-5">
                ...
                <div class="text-center mb-4 position-relative" style="z-index: 2;">
                    <h2 class="fw-bolder text-gold mb-1">Masuk</h2>
                    <p class="text-dark small fw-semibold">Silahkan Masuk Dengan Akun Anda</p>
                </div>

                <div class="toggle-bg mb-4 position-relative" style="z-index: 2;">
                    <a href="#" class="toggle-btn active">Masuk</a>
                    <a href="{{ route('register') }}" class="toggle-btn">Daftar</a>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="position-relative" style="z-index: 2;">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label fw-bold text-dark mb-1" style="font-size: 0.85rem;">Email</label>
                        <div class="input-group bg-white overflow-hidden py-1">
                            <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                            <input id="email" type="email" class="form-control custom-input" name="email" value="{{ old('email') }}" required autofocus placeholder="Masukkan Email">
                        </div>
                        @error('email')
                    ...
                    <div class="mb-2">
                        <label for="password" class="form-label fw-bold text-dark mb-1" style="font-size: 0.85rem;">Password</label>
                        <div class="input-group bg-white overflow-hidden py-1">
                            <span class="input-group-text"><i class="bi bi-lock"></i></span>
                            <input id="password" type="password" class="form-control custom-input" name="password" required placeholder="Masukkan Password">
                            <button type="button" class="input-group-text pe-3" id="togglePassword" style="cursor: pointer; color: #ADB5BD;">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
                        @error('password')
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-gold text-decoration-none fw-bold" style="font-size: 0.8rem;">Lupa Password?</a>
                        @endif
                    </div>

                    <button type="submit" class="btn btn-gold w-100 py-2 fs-6 mt-1">
                        Masuk
                    </button>
                </form>
            </div>
...
<script>
    ...
    togglePassword.addEventListener('click', function () {
        ...
        // Merubah warna ikon saat diklik
        if(type === 'text') {
